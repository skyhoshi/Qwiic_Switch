@echo Programming the Qwiic Switch. If this looks incorrect, abort and retry.
@pause
:loop
...
@avrdude -C avrdude.conf -pattiny84 -cusbtiny -Uflash:w:Qwiic_Switch_Firmware.ino.hex
